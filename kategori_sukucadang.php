...
<?php  
  ...
  $sql = " SELECT * FROM barang WHERE kategori = 'SC' LIMIT $start_from, $jum";
    ...
    <div class="row">
       ...
       <div class="col-md-3 col-sm-3 col-xs-6">
            ...
            <div class="list-group">
             ...
             <a href="kategori_sepedabmx.php" class="list-group-item">Sepeda Bmx</a>
            ...
            <div class="list-group">
             ...
             <a href="kategori_sukucadang.php" class="list-group-item active">Suku Cadang</a>
            </div>
        </div>
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            <div class="row">
            <?php while($sukucadang = mysqli_fetch_assoc($kategori)) : ?>
              <div class="col-md-3 col-sm-3 col-xs-6">
              <div class="thumbnail" style="-webkit-box-shadow: 0px 5px 16px -3px rgba(0,0,0,0.60); -moz-box-shadow: 0px 5px 16px -3px rgba(0,0,0,0.60); box-shadow: 0px 5px 16px -3px rgba(0,0,0,0.60);" >
               <img src="<?= $sukucadang['foto']; ?>" alt="<?= $sukucadang['nama_brg']; ?>" style="width:auto; height:200px; padding-top: 20px;">
                  <div class="caption">
                      <h5> <?= $sukucadang['nama_brg']; ?> </h5>
                      <p> Harga : <?= money($sukucadang['harga_jual']); ?></p>
                      <p><a  href="#" class="btn-sm btn-primary" onclick="detailsmodal('<?= $sukucadang['kode_brg'] ?>')">Details</a></p>
                  </div>
               </div>
               </div>
            <?php endwhile; ?> 
            ...
            <?php 
              $querypage = mysqli_query($db,"SELECT * FROM barang WHERE kategori = 'SC'");
          ...
          <div class="col-md-12 text-center">
            <!-- <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate"> -->
                ...
                <a href='kategori_sukucadang.php?page=1'><span class='fa fa-backward'></span></a></li>";

                for ($i=1; $i<=$total_pages; $i++) { 
                    if($i == $page) {
                    echo 
                    "<li class='paginate_button active' aria-controls='dataTables-example' tabindex='0'>
                    <a href='kategori_sukucadang.php?page=".$i."'> ".$i." </a></li>";
                    } else {
                    echo 
                ...
                <a href='kategori_sukucadang.php?page=$total_pages'><span class='fa fa-forward'></span></a>
                </li>";
                ?>
                </ul>
            </div>
