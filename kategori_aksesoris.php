...
<?php  
  ...
  $sql = " SELECT * FROM barang WHERE kategori = 'AC' LIMIT $start_from, $jum";
    ...
    <div class="row">
       ...
       <div class="col-md-3 col-sm-3 col-xs-12">
            ...
            <div class="list-group">
             ...
             <a href="kategori_aksesoris.php" class="list-group-item active">Aksesoris</a>
        ...
        <div class="col-md-9 col-sm-9 col-xs-10">
            ...
            <?php while($k = mysqli_fetch_assoc($kategori)) : ?>
              ...
              <div class="thumbnail" style="-webkit-box-shadow: 0px 5px 16px -3px rgba(0,0,0,0.60); -moz-box-shadow: 0px 5px 16px -3px rgba(0,0,0,0.60); box-shadow: 0px 5px 16px -3px rgba(0,0,0,0.60);" >
               <img src="<?= $k['foto']; ?>" alt="<?= $k['nama_brg']; ?>" class="img-thumb" style="width:auto; height:200px;padding-top: 20px;">
                   <div class="caption">
                      <h5> <?= $k['nama_brg']; ?> </h5>
                      <p> Harga : <?= money($k['harga_jual'])?></p>
                      <button type="button" class="btn btn-sm btn-primary" onclick="detailsmodal('<?= $k['kode_brg'] ?>')">Details</button>
                    </div>
               </div>
              </div>
            <?php endwhile; ?> 
            ...
            <?php 
              $querypage = mysqli_query($db,"SELECT * FROM barang WHERE kategori = 'AC'");
          ...
          <div class="col-md-12 text-center">
                ...
                <a href='kategori_aksesoris.php?page=1'><span class='fa fa-backward'></span></a></li>";

                for ($i=1; $i<=$total_pages; $i++) { 
                    if($i == $page) {
                    echo 
                    "<li class='paginate_button active' aria-controls='dataTables-example' tabindex='0'>
                    <a href='kategori_aksesoris.php?page=".$i."'> ".$i." </a></li>";
                    } else {
                    echo 
                ...
                <a href='kategori_aksesoris.php?page=$total_pages'><span class='fa fa-forward'></span></a>
                </li>";
                ?>
                </ul>
            </div>
