...
<?php  
  ...
  $sql = " SELECT * FROM barang WHERE kategori = 'BK' LIMIT $start_from, $jum ";
    ...
    <div class="row">
       ...
       <div class="col-md-3 col-sm-3 col-xs-12">
            ...
            <div class="list-group">
             ...
             <a href="kategori_sepedaanak.php" class="list-group-item active">Sepeda Anak / Kids Bike</a>
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <?php endwhile; ?> 
             ...
             <?php 
              $querypage = mysqli_query($db,"SELECT * FROM barang WHERE kategori = 'BK'");
          ...
          <div class="col-md-12 text-center">
                ...
                <a href='kategori_sepedaanak.php?page=1'><span class='fa fa-backward'></span></a></li>";

                for ($i=1; $i<=$total_pages; $i++) { 
                    if($i == $page) {
                    echo 
                    "<li class='paginate_button active' aria-controls='dataTables-example' tabindex='0'>
                    <a href='kategori_sepedaanak.php?page=".$i."'> ".$i." </a></li>";
                    } else {
                    echo 
                ...
                <a href='kategori_sepedaanak.php?page=$total_pages'><span class='fa fa-forward'></span></a>
                </li>";
                ?>
                </ul>
            </div>
